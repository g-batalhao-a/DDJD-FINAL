...
public class Boat1Movement : MonoBehaviour
{
    ...
    public float leftSpeed = 0f, rightSpeed = 0f, leftAcceleration = 0f, rightAcceleration = 0f;
    
    public float leftPressed = 0f, rightPressed = 0f;
    ...
    private void getLeftCenter() {
        leftCenter = transform.GetChild(0).position; // 1st child of Boat GameObject should always be leftAnchor
    }
    
    private void getRightCenter() {
        rightCenter = transform.GetChild(1).position; // 2nd child of Boat GameObject should always be rightAnchor
    }
